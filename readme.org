...
- Fixes: a superseded search can no longer land its pages in the results, items the endpoint repeats across pages are dropped, and the package byte-compiles clean on Emacs 31.
